...
import com.eja.firebaseapp.adapter.MainAdapter;
...
public class MainActivity extends AppCompatActivity implements MainAdapter.FirebaseDataListener {
    ...
    private void dialogTambahBarang() {
        ...
        mEditTipe = view.findViewById(R.id.tipe_barang);
        ...
        builder.setPositiveButton("SIMPAN", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int id) {
                ...
                String tipeBarang = mEditTipe.getText().toString();
                String hargaBarang = mEditHarga.getText().toString();

                if (!namaBarang.isEmpty() && !merkBarang.isEmpty() && !hargaBarang.isEmpty()) {
                    submitDataBarang(new ModelBarang(namaBarang, merkBarang, tipeBarang, hargaBarang));
                } else {
    ...
    private void dialogUpdateBarang(final ModelBarang barang) {
        ...
        mEditTipe.setText(barang.getTipe());
        ...
        if (barang != null) {
            builder.setPositiveButton("SIMPAN", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int id) {
                    ...
                    barang.setTipe(mEditTipe.getText().toString());
